...
namespace Icarus.Controllers
{
    public class FacilityReportController : Controller
    {
        ...
        // GET: FacilityReport/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: FacilityReport/Create
